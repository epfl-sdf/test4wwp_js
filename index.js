...
app.get('/', function(req, res) {
  ...
  if ('url1' in params && 'url2' in params) {
    var iframe1 = '<iframe id="frame1" src="' + params['url1'] + '" width="49%" height="1000" align="left" scrolling="yes"></iframe>';
    var iframe2 = '<iframe id="frame2" src="' + params['url2'] + '" width="49%" height="1000" align="right" scrolling="yes"></iframe>';
    res.write(iframe1);
    res.write(iframe2);
